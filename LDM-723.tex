...
\citeds{LDM-612}: Plans and Policies for LSST Alert Distribution, has been updated, and proposers are encouraged to review it for information on evaluation criteria.
...
\item If you are requesting a direct connection to the stream, what capacity do you have to forward alerts to more specialized broker systems downstream?  Are there other teams you have agreed to forward alerts to?
\end{itemize}
...
\item Who will be eligible to use your broker?  (Broad access is preferred.)
...
\item Describe community usage your broker system on any of the above, or plans to encourage community adoption of your service.
\end{itemize}
